...
// Props: widgets, preview, deletedWidgets, togglePreview, updateWidget, 
//     deleteWidget, saveWidgets, moveUp, moveDown
            ...
            <div className="container">
                <div className="row">
                    <div className="ml-auto mr-3">
                        ...
                        <label htmlFor="switch" className="mr-1">Preview</label>
                                ...
                                {!this.props.preview &&
                                    <div className="float-right">
                                        {widget.widgetIndex !== 0 &&
                                            <button onClick={() => this.props.moveUp(widget.widgetIndex)}
                                                className="btn btn-sm btn-warning mr-1">
                                                <i className="fas fa-arrow-up"></i>
                                            </button>
                                        }
                                        {widget.widgetIndex !== this.props.widgets.length - 1 &&
                                            <button onClick={() => this.props.moveDown(widget.widgetIndex)}
                                                className="btn btn-sm btn-warning mr-1">
