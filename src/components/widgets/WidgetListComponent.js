...
// Props: widgets, preview, togglePreview, updateWidget, deleteWidget
            ...
            <div className="container">
                <div className="row">
                    <div className="ml-auto mr-3">
                        ...
                        <Switch onClick={() => this.props.togglePreview(this.props.preview)} on={this.props.preview}>
                            Preview
                        </Switch>
                    </div>
                </div>
                <ul className="list-group">
                    {this.props.widgets.map((widget, index) => (
                        <li key={index} className="list-group-item">
                            ...
                            <div>
                                {widget.type === HEADING_WIDGET && <HeadingWidget widget={widget} updateWidget={this.props.updateWidget} />}
                                {widget.type === PARAGRAPH_WIDGET && <ParagraphWidget widget={widget} updateWidget={this.props.updateWidget} />}
                                {widget.type === LIST_WIDGET && <ListWidget widget={widget} updateWidget={this.props.updateWidget} />}
                                {widget.type === LINK_WIDGET && <LinkWidget widget={widget} updateWidget={this.props.updateWidget} />}
                                {widget.type === IMAGE_WIDGET && <ImageWidget widget={widget} updateWidget={this.props.updateWidget} />}
                            </div>
                        </li>
                    ))}
                </ul>
